...
function h(a) {
  ...
  if ("number" === c && !1 === isNaN(a)) {
    return b.f ? (b = Math.abs(a), a = 864E5 <= b ? n(a, b, 864E5, "day") : 36E5 <= b ? n(a, b, 36E5, "hour") : 6E4 <= b ? n(a, b, 6E4, "minute") : 1000 <= b ? n(a, b, 1000, "second") : a + " ms") : (b = Math.abs(a), a = 864E5 <= b ? Math.round(a / 864E5) + "d" : 36E5 <= b ? Math.round(a / 36E5) + "h" : 6E4 <= b ? Math.round(a / 6E4) + "m" : 1000 <= b ? Math.round(a / 1000) + "s" : a + "ms"), a;
  }
...
const u = Object.keys(process.env).filter(a => /^debug_/i.test(a)).reduce((a, b) => {
  ...
  return process.stderr.write(util.format(...a) + "\n");
